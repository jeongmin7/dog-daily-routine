...
- 로드맵 남은 것: **프론트 리팩터**(착수 전 testing-library+jsdom로 **컴포넌트 테스트 먼저** — 현재 0개라 안전망 없음) · **MVP 1b-ii**(약 알림 — cron+채널, 보류) · **MVP 3**(AI 사료분석 — GPT/Claude Vision) · **MVP 4**(NestJS+Docker 분리).
