...
-- AddForeignKey
ALTER TABLE "DogRecord" ADD CONSTRAINT "DogRecord_dogId_fkey" FOREIGN KEY ("dogId") REFERENCES "Dog"("id") ON DELETE CASCADE ON UPDATE CASCADE;
